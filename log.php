...
$ret=mysqli_query($con,"SELECT * FROM `pharmacist` WHERE `username`='$username' AND `password`='$password' AND `status`='active'");
$num=mysqli_fetch_array($ret) ;
$n=mysqli_num_rows($ret) ;
if($n>0)
{
$_SESSION['user'] = $num['username'];
$_SESSION['action1']="*wellcome";
$extra="pharmasist.php";
...
<!--navigation menu-->
	...
	<div class="container well pad">
	 <div class="col-md-offset-0"> 
        ...
        <h2 class="col-sm-offset-2"><span class="glyphicon glyphicon-log-in"></span> Pharmasist Login</h2>
